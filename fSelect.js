...
(function($) {
    ...
    $.fn.fSelect = function(options) {
        ...
        fSelect.prototype = {
            create: function() {
                ...
                // Get the selected values, ensure it's an array, and sort it alphabetically
                this.selected = [].concat(this.$select.val()).sort((a, b) => a.localeCompare(b));
    ...
    $(document).on('click', function(e) {
        ...
        if (0 < $wrap.length) {
            ...
            if ($el.hasClass('fs-label') || $el.hasClass('fs-arrow') || $el.hasClass('fs-label-wrap')  ) {
